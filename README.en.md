...
Current repository version: `1.3.5`

Version `1.3.5` adds Vietnamese and Thai UI support and refreshes the contact-author copy across all 12 supported languages.
